...
import { FaviconSetting } from "@/components/admin/favicon-setting";
    ...
    return (
        <div className="flex min-h-full flex-col">
            <header className="flex flex-col gap-2 px-4 py-6 sm:px-6">
                <h1 className="text-4xl font-black leading-tight tracking-[-0.033em] text-foreground">{t('blogSettings')}</h1>
                <p className="max-w-2xl text-sm leading-6 text-muted-foreground sm:text-base">{t('blogSettingsDesc')}</p>
            </header>

            <main className="flex-1 overflow-auto px-4 pb-6 sm:px-6">
                <div className="max-w-2xl space-y-8">
                    {saved && (
                        <div className="rounded-lg border border-primary/20 bg-primary/10 p-4 text-sm text-foreground" aria-live="polite">
                            {t('settingsSaved')}
                        </div>
                    )}
                    {error && (
                        <div className="rounded-lg border border-destructive/30 bg-destructive/10 p-4 text-sm text-destructive" role="alert" aria-live="polite">
                            {error}
                        </div>
                    )}
                    ...
                    <form action={updateSettings} className="space-y-8">
                        <section className="space-y-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <FaviconSetting
                                    defaultUrl={settings.faviconUrl || ''}
                                    translations={{
                                        favicon: t('favicon'),
                                        faviconDesc: t('faviconDesc'),
                        ...
                        <section className="space-y-4">
                            <h2 className="text-lg font-semibold tracking-tight text-foreground">{t('userRegistration')}</h2>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-lg font-semibold tracking-tight text-foreground">{t('mediaStorage')}</h2>
                            <S3Settings
                        ...
                        <section className="space-y-4">
                            <h2 className="text-lg font-semibold tracking-tight text-foreground">{t('emailService')}</h2>
                            <EmailSettings
                        ...
                        <section className="space-y-4">
                            <h2 className="text-lg font-semibold tracking-tight text-foreground">{t('aiSpamDetection')}</h2>
                            <AiSettings
