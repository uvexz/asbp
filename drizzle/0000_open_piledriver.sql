...
CREATE TABLE "posts_tags" (
	"postId" uuid NOT NULL,
	"tagId" uuid NOT NULL,
	CONSTRAINT "posts_tags_postId_tagId_pk" PRIMARY KEY("postId","tagId")
);
--> statement-breakpoint
...
ALTER TABLE "posts_tags" ADD CONSTRAINT "posts_tags_postId_post_id_fk" FOREIGN KEY ("postId") REFERENCES "public"."post"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "posts_tags" ADD CONSTRAINT "posts_tags_tagId_tag_id_fk" FOREIGN KEY ("tagId") REFERENCES "public"."tag"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
